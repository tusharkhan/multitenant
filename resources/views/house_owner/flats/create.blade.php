        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        <i class="fas fa-home me-2"></i>Add New Flat to {{ $building->name }}
                    </h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('house_owner.flats.store', $building) }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('owner_address') is-invalid @enderror" 
                                      ...
                                      name="owner_address" 
                                      rows="3" 
                                      placeholder="Owner's permanent address">{{ old('owner_address') }}</textarea>
                            @error('owner_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('bedrooms') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('bedrooms') == '1' ? 'selected' : '' }}>1 BHK</option>
                                        <option value="2" {{ old('bedrooms') == '2' ? 'selected' : '' }}>2 BHK</option>
                                        <option value="3" {{ old('bedrooms') == '3' ? 'selected' : '' }}>3 BHK</option>
                                        <option value="4" {{ old('bedrooms') == '4' ? 'selected' : '' }}>4 BHK</option>
                                        <option value="5" {{ old('bedrooms') == '5' ? 'selected' : '' }}>5+ BHK</option>
                                    </select>
                                    @error('bedrooms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      name="notes" 
                                      rows="3" 
                                      placeholder="Any additional notes about this flat">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i>Create Flat
                                    </button>
                                </div>
                            </div>
                        </div>
